...
- Подбор гиперпараметров эволюционными алгоритмами позволяют оптимизировать модель и повысить ее точность.
  ...
  <img src="https://github.com/kh4k1m/projeckt23/blob/main/images/res0.jpg" width="600" height="300">
  <img src="https://github.com/kh4k1m/projeckt23/blob/main/images/res1.jpg" width="600" height="300">
...
- В качестве кастомной аугментации были использованы:  
    - Погодная аугментация – дождь, снег и тени  
...
<img src="https://github.com/kh4k1m/projeckt23/blob/main/images/streamlit.jpg" width="600" height="300">  
